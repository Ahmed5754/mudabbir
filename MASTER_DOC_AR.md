...
- هذا المستودع يتتبع كودًا مخصصًا محليًا بهدف التطوير السريع.
- عند نشر حزمة Mudabbir بشكل رسمي، يجب تحديث بيانات الحزمة ونقاط الدخول بما يتوافق مع الإصدار المنشور.
- هذا الملف يستبدل ويجمع محتوى الملفات التالية:
  - `CLAUDE.md`
  - `README.md`
