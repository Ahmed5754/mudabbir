---
title: Roadmap
description: "What we've shipped, what we're building next, and where Mudabbir is headed."
section: Advanced
ogType: article
keywords: ["roadmap", "mudabbir roadmap", "upcoming features", "release plan", "webmcp"]
...
We ship what unblocks users first. Security and reliability fixes jump the queue. Feature requests from GitHub issues influence what gets built, so if you want something, [open an issue](https://github.com/Ahmed5754/Mudabbir/issues).
