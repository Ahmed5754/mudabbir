---
title: Self-Hosting
description: "Deploy Mudabbir on your own server: system requirements, Python 3.11+ setup, reverse proxy configuration with Nginx, SSL certificates, and production hardening recommendations for self-hosted AI."
section: Deployment
ogType: article
...
6. **Run security audit** — `mudabbir --security-audit`
