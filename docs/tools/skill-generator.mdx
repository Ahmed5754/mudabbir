...
description: "Create persistent skill definitions that teach Mudabbir new capabilities. The skill generator writes SKILL.md files to ~/.claude/skills/ (the SDK standard location) and hot-reloads them into the agent context."
section: Tools
ogType: article
...
The loader also checks `~/.agents/skills/` and `~/.mudabbir/skills/` for backwards compatibility.
