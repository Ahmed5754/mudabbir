---
title: Desktop
description: "Capture screenshots and monitor system resources with Mudabbir's desktop tools. Take screenshots of your primary monitor and check CPU, RAM, disk usage, and battery status on demand."
section: Tools
ogType: article
...
Agent: [uses take_screenshot] → Screenshot saved to ~/.mudabbir/file_jail/screenshots/screenshot_20240115_143022.png
```

Screenshots are saved to `~/.mudabbir/file_jail/screenshots/` with timestamped filenames.
...
export MUDABBIR_TOOLS_ALLOW="group:desktop"
```
