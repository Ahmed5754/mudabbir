---
title: Research
description: "Mudabbir's research tool performs multi-step web research by chaining search, URL extraction, content fetching, and LLM summarization for thorough answers backed by multiple sources."
section: Tools
ogType: article
...
export MUDABBIR_TAVILY_API_KEY="tvly-..."
```
