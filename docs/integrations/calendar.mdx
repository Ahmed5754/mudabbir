...
description: "Manage Google Calendar events with Mudabbir: list upcoming events, create new ones with attendees and reminders, and search across all your calendars using natural language queries."
...
Mudabbir can manage your Google Calendar with three tools: list, create, and search.

## Setup

1. Set up [Google OAuth](/integrations/oauth) credentials
2. Enable the Google Calendar API in your Google Cloud project
3. Authorize Mudabbir to access your calendar
