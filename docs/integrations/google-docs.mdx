---
title: Google Docs
description: "Read, create, and search Google Docs with Mudabbir. Extract document content as plain text, create new documents with formatted content, and search across your Docs library by title or content."
...
Mudabbir can interact with Google Docs for reading, creating, and searching documents.

## Setup

1. Set up [Google OAuth](/integrations/oauth) credentials
2. Enable the Google Docs API in your Google Cloud project
3. Authorize Mudabbir to access your Docs
