---
title: Discord
description: "Run Mudabbir as a Discord bot with /mudabbir slash commands, DM and mention support, streaming responses with edit-in-place, and configurable guild and user allow-lists."
section: Channels
ogType: article
...
```
/mudabbir What files are in the home directory?
```
...
export MUDABBIR_DISCORD_ALLOWED_GUILD_IDS="111222333,444555666"

# Restrict to specific users
export MUDABBIR_DISCORD_ALLOWED_USER_IDS="777888999"
```
