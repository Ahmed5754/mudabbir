---
title: Signal
description: "Connect Mudabbir to Signal for privacy-focused AI assistance. Uses signal-cli REST API with HTTP polling every 2 seconds. End-to-end encrypted messaging with your AI agent."
section: Channels
ogType: article
...
You need a running [signal-cli-rest-api](https://github.com/bbernhard/signal-cli-rest-api) instance. This provides the HTTP API that Mudabbir communicates with.
...
|---------|-------------|-------------|
| API URL | `MUDABBIR_SIGNAL_API_URL` | signal-cli REST API URL |
| Phone number | `MUDABBIR_SIGNAL_PHONE_NUMBER` | Your registered Signal number |
| Allowed numbers | `MUDABBIR_SIGNAL_ALLOWED_NUMBERS` | Comma-separated allowed numbers |
