---
title: Telegram
description: "Connect Mudabbir to Telegram as a bot with topic-aware conversations, inline keyboards, and streaming responses. Supports group chats and private messages with session isolation."
section: Channels
ogType: article
...
|---------|-------------|-------------|
| Bot token | `MUDABBIR_TELEGRAM_TOKEN` | Bot token from BotFather |
| Allowed user IDs | `MUDABBIR_ALLOWED_TELEGRAM_IDS` | Comma-separated user IDs |
