...
# For Ollama (local)
export MUDABBIR_OI_MODEL="ollama/llama3.2"

# For OpenAI
export MUDABBIR_OI_MODEL="gpt-4o"
export MUDABBIR_OPENAI_API_KEY="sk-..."

# For Anthropic
export MUDABBIR_OI_MODEL="claude-sonnet-4-5-20250929"
...
- No built-in safety hooks (relies on Mudabbir's Guardian AI)
