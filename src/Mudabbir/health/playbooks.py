...
PLAYBOOKS: dict[str, dict] = {
    "api_key_primary": {
        ...
        "fix_steps": [
            ...
            "Or set ANTHROPIC_API_KEY (or Mudabbir_ANTHROPIC_API_KEY) in your shell environment",
            "Restart Mudabbir after changing environment variables",
        ],
        "auto_fixable": False,
    },
    "llm_reachable": {
    ...
    "config_valid_json": {
        "symptom": "Mudabbir ignores your settings and uses defaults",
        "causes": [
            "Manual edit introduced syntax error in config.json",
            "File was corrupted (disk issue, interrupted write)",
        ],
        "fix_steps": [
            "Open ~/.Mudabbir/config.json in a text editor",
    ...
    "disk_space": {
        ...
        "fix_steps": [
            ...
            "Clear audit logs: truncate ~/.Mudabbir/audit.jsonl",
    ...
    "config_permissions": {
        ...
        "fix_steps": [
            ...
            "Run: chmod 600 ~/.Mudabbir/secrets.enc",
        ],
        "auto_fixable": True,
    },
    "secrets_encrypted": {
...
def diagnose_config(section: str = "") -> str:
    ...
    """
    from Mudabbir.health.checks import STARTUP_CHECKS, HealthCheckResult
