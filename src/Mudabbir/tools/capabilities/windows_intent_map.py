...
RULES: tuple[IntentRule, ...] = (
    ...
    IntentRule("system.battery_status", "system_info", "battery", "safe", ("battery percentage", "battery status", "نسبة البطارية", "نسبه البطاريه")),
    ...
    IntentRule("audio.play_pause", "media_control", "play_pause", "safe", ("play pause", "pause media", "ايقاف مؤقت", "تشغيل او ايقاف مؤقت")),
    ...
    IntentRule("display.clipboard_history", "clipboard_tools", "history", "safe", ("clipboard history", "سجل الحافظة", "سجل الحافظه", "الحافظة السحابية")),
    ...
    IntentRule("network.settings_open", "open_settings_page", "network", "safe", ("open network settings", "فتح إعدادات الشبكة", "فتح اعدادات الشبكه"), params=("page",)),
