...
RULES: tuple[IntentRule, ...] = (
    ...
    IntentRule("settings.update_open", "open_settings_page", "windowsupdate", "safe", ("windows update settings", "open windows update", "اعدادات التحديث", "إعدادات التحديث", "افتح تحديثات ويندوز"), params=("page",)),
    IntentRule("settings.apps_open", "open_settings_page", "appsfeatures", "safe", ("apps settings", "apps features", "app settings", "اعدادات التطبيقات", "إعدادات التطبيقات"), params=("page",)),
    IntentRule("settings.sound_open", "open_settings_page", "sound", "safe", ("sound settings", "open sound settings", "اعدادات الصوت", "إعدادات الصوت"), params=("page",)),
    ...
    IntentRule(
        ...
        (
            "top ram",
            "اكثر العمليات استهلاكا للرام",
            "اعلى استهلاك رام",
            "اعلى استهلاك ذاكره",
            "اكتر مهمة تستهلك رامات",
            "اكثر مهمة تستهلك رامات",
    ...
    IntentRule("mouse.clip_cursor", "automation_tools", "mouse_lock_on", "safe", ("clip cursor", "lock mouse to screen")),
    IntentRule("mouse.clip_cursor_window", "automation_tools", "mouse_lock_window", "safe", ("lock mouse to active window", "lock mouse in window", "حجز الماوس داخل النافذة", "حجز الماوس داخل النافذه", "ثبت الماوس داخل النافذة")),
    IntentRule("mouse.clip_cursor_off", "automation_tools", "mouse_lock_off", "safe", ("unlock mouse", "release mouse lock", "فك حجز الماوس", "الغاء حجز الماوس", "إلغاء حجز الماوس")),
    ...
    IntentRule("shell.quick_settings", "shell_tools", "quick_settings", "safe", ("quick settings", "win+a", "الاعدادات السريعه", "الاعدادات السريعة")),
    IntentRule("shell.notifications", "shell_tools", "notifications", "safe", ("notification center", "win+n", "مركز الاشعارات", "مركز الاشعارات")),
    IntentRule("shell.search", "shell_tools", "search", "safe", ("windows search", "win+s", "بحث ويندوز")),
    IntentRule("shell.run", "shell_tools", "run", "safe", ("run dialog", "win+r", "نافذه run")),
