...
def _enrich_project_dict(project_dict: dict) -> dict:
    ...
    from Mudabbir.mission_control.manager import get_project_dir
...
async def get_plan(project_id: str) -> dict[str, Any]:
    ...
    """
    from Mudabbir.deep_work.scheduler import DependencyScheduler
    from Mudabbir.mission_control.manager import get_mission_control_manager
...
async def approve_project(project_id: str) -> dict[str, Any]:
    ...
    from Mudabbir.deep_work import approve_project as _approve
...
async def pause_project(project_id: str) -> dict[str, Any]:
    ...
    from Mudabbir.deep_work import pause_project as _pause
...
async def resume_project(project_id: str) -> dict[str, Any]:
    ...
    from Mudabbir.deep_work import resume_project as _resume
...
async def skip_task(project_id: str, task_id: str) -> dict[str, Any]:
    ...
    from Mudabbir.deep_work import get_deep_work_session
    from Mudabbir.mission_control.manager import get_mission_control_manager
    from Mudabbir.mission_control.models import TaskStatus, now_iso
