...
try:
    ...
    raise ImportError(
        ...
        "but not installed. Install them with: pip install 'Mudabbir[dashboard]'"
    ) from _exc
...
def create_app(settings: Settings) -> FastAPI:
    ...
    app = FastAPI(title="Mudabbir Setup")
...
<body>
    <div class="container">
        ...
        <div id="success-section" class="success" style="display: none;">
            ✅ <strong>Connected!</strong> Mudabbir is now running.
        </div>
    </div>
