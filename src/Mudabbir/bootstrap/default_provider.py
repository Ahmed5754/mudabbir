...
from Mudabbir.bootstrap.protocol import BootstrapContext, BootstrapProviderProtocol
...
class DefaultBootstrapProvider(BootstrapProviderProtocol):
    """
    Loads identity from:
    - ~/.Mudabbir/identity/IDENTITY.md
    - ~/.Mudabbir/identity/SOUL.md
    - ~/.Mudabbir/identity/STYLE.md
    """
    ...
    def _ensure_defaults(self) -> None:
        ...
        if not identity_file.exists():
            identity_file.write_text(
                "You are Mudabbir, an AI agent running locally on the user's machine.\n"
